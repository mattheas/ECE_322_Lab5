...
class TestD(unittest.TestCase):
    ...
    def test_insertData_method(self):
        ...
        with open('./bottomuptests/TestDF_redirect_output_insert_method_actual.txt', 'w') as f1:
        ...
        f1 = open("./bottomuptests/TestDF_redirect_output_insert_method_actual.txt", "r")
        f2 = open("./bottomuptests/TestDF_redirect_output_insert_method_expected.txt", "r")
        i = 0
        for line1 in f1:
            i+=1
            for line2 in f2:
    ...
    def test_updateData_method(self):
        ...
        with open('./bottomuptests/TestDF_redirect_output_update_method_actual.txt', 'w') as f1:
            with redirect_stdout(f1):
        ...
        # assert ModuleF works as expected printing to terminal
        f1 = open("./bottomuptests/TestDF_redirect_output_update_method_actual.txt", "r")
        f2 = open("./bottomuptests/TestDF_redirect_output_update_method_expected.txt", "r")
        i = 0
        for line1 in f1:
            i+=1
            for line2 in f2:
    ...
    def test_deleteData_method(self):
        ...
        with open('./bottomuptests/TestDF_redirect_output_delete_method_actual.txt', 'w') as f1:
            with redirect_stdout(f1):
        ...
        # assert ModuleF works as expected printing to terminal
        f1 = open("./bottomuptests/TestDF_redirect_output_delete_method_actual.txt", "r")
        f2 = open("./bottomuptests/TestDF_redirect_output_delete_method_expected.txt", "r")
        i = 0
        for line1 in f1:
            i+=1
            for line2 in f2:
