...
class TestC(unittest.TestCase):
    ...
    def test_sortData_method(self):
        ...
        with open('./tests/TestCF_redirect_output_actual.txt', 'w') as f1:
        ...
        f1 = open("./tests/TestCF_redirect_output_actual.txt", "r")
        f2 = open("./tests/TestCF_redirect_output_expected.txt", "r")
        i = 0
        for line1 in f1:
            i+=1
            for line2 in f2:
